...
// Pixify, character engine of the game Miratelo, modified version for the gamejam, support 2D gameplay
// version 0.3, features not complete, not ready for a full game
namespace Pixify
{
    // base component shard
    ...
    public abstract class pix
    {
        ...
        public void iDestroy ( block b )
        {
            if (this.b == b)
            Destroy ();
            else Debug.LogError ("pixi is not attached to this block, Can't destroy");
        }
